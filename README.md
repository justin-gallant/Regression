...
Here, $f$ is a monotonic function mapping surprise to a $[0,1]$ weight. A common choice is $w = exp(-\alpha * \text{surprise})$ (exponential decay). 
Usually the function $f$ possesses a hyperparameter controlling weight sensitivity, in this example $\alpha$.  
